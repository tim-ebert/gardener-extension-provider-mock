...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*NetworkConfig)(nil), (*mock.NetworkConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_NetworkConfig_To_mock_NetworkConfig(a.(*NetworkConfig), b.(*mock.NetworkConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*mock.NetworkConfig)(nil), (*NetworkConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_mock_NetworkConfig_To_v1alpha1_NetworkConfig(a.(*mock.NetworkConfig), b.(*NetworkConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*NetworkStatus)(nil), (*mock.NetworkStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_NetworkStatus_To_mock_NetworkStatus(a.(*NetworkStatus), b.(*mock.NetworkStatus), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*mock.NetworkStatus)(nil), (*NetworkStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_mock_NetworkStatus_To_v1alpha1_NetworkStatus(a.(*mock.NetworkStatus), b.(*NetworkStatus), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_NetworkConfig_To_mock_NetworkConfig(in *NetworkConfig, out *mock.NetworkConfig, s conversion.Scope) error {
	return nil
}

// Convert_v1alpha1_NetworkConfig_To_mock_NetworkConfig is an autogenerated conversion function.
func Convert_v1alpha1_NetworkConfig_To_mock_NetworkConfig(in *NetworkConfig, out *mock.NetworkConfig, s conversion.Scope) error {
	return autoConvert_v1alpha1_NetworkConfig_To_mock_NetworkConfig(in, out, s)
}

func autoConvert_mock_NetworkConfig_To_v1alpha1_NetworkConfig(in *mock.NetworkConfig, out *NetworkConfig, s conversion.Scope) error {
	return nil
}

// Convert_mock_NetworkConfig_To_v1alpha1_NetworkConfig is an autogenerated conversion function.
func Convert_mock_NetworkConfig_To_v1alpha1_NetworkConfig(in *mock.NetworkConfig, out *NetworkConfig, s conversion.Scope) error {
	return autoConvert_mock_NetworkConfig_To_v1alpha1_NetworkConfig(in, out, s)
}

func autoConvert_v1alpha1_NetworkStatus_To_mock_NetworkStatus(in *NetworkStatus, out *mock.NetworkStatus, s conversion.Scope) error {
	return nil
}

// Convert_v1alpha1_NetworkStatus_To_mock_NetworkStatus is an autogenerated conversion function.
func Convert_v1alpha1_NetworkStatus_To_mock_NetworkStatus(in *NetworkStatus, out *mock.NetworkStatus, s conversion.Scope) error {
	return autoConvert_v1alpha1_NetworkStatus_To_mock_NetworkStatus(in, out, s)
}

func autoConvert_mock_NetworkStatus_To_v1alpha1_NetworkStatus(in *mock.NetworkStatus, out *NetworkStatus, s conversion.Scope) error {
	return nil
}

// Convert_mock_NetworkStatus_To_v1alpha1_NetworkStatus is an autogenerated conversion function.
func Convert_mock_NetworkStatus_To_v1alpha1_NetworkStatus(in *mock.NetworkStatus, out *NetworkStatus, s conversion.Scope) error {
	return autoConvert_mock_NetworkStatus_To_v1alpha1_NetworkStatus(in, out, s)
}
